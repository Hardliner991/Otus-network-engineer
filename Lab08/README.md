...
Зафиксируете в документации - план работы, схему сети, настройки сетевого оборудования.

### Схема: 
![](https://github.com/Hardliner991/Otus-network-engineer/blob/main/Lab08/L3VPNTopology.png)
...
localhost(config)#sh running-config
! Command: show running-config
! device: localhost (vEOS-lab, EOS-4.28.0F)
!
! boot system flash:/vEOS-lab.swi
